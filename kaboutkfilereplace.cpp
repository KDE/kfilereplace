/***************************************************************************
    ...
    copyright            : (C) 2000 by Fran�is Dupoux
  ...
  :KAboutDialog(AbtKDEStandard | AbtProduct, "KFileReplace", KDialogBase::Close, KDialogBase::Close, parent, name, modal)
{
  ...
  setImageFrame(false);
  setProduct(QString(PACKAGE), QString(VERSION), QString("Fran�is Dupoux"), QString("2002"));
  ...
  if (cAuthors)
    {
      cAuthors->addPerson(QString("Fran�is Dupoux"), QString("dupoux@dupoux.com"), QString::null, i18n("Main author and French translator"), true);
